...
export function Food() {
  return (
    <div className="flex w-20 h-20 p-3 text-green-900 bg-gray-200 rounded-full place-items-center">
...
export function Cardio() {
  return (
    <div className="flex w-20 h-20 p-3 text-blue-800 bg-gray-200 rounded-full place-items-center">
...
export function Strength() {
  return (
    <div className="flex w-20 h-20 p-3 text-red-800 bg-gray-200 rounded-full place-items-center">
